...
// la sumaremos aquí mismo más adelante, cuando ya exista la pantalla de login y los roles.
...
export const config = {
  matcher: [
    ...
    // no necesitan sesión y hacerlos pasar por aquí solo agregaría trabajo inútil en cada carga.
